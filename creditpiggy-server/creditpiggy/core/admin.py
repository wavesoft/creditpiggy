...
admin.site.register(ProjectAchievement)
admin.site.register(Achievement)
admin.site.register(Campaign)
admin.site.register(CampaignAchievement)
admin.site.register(CampaignUserCredit)
admin.site.register(CampaignProject)
admin.site.register(AwardedUserProjectAchievement)
admin.site.register(AwardedUserCampaignAchievement)
