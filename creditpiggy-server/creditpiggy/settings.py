...
CACHES = {
	'default': {
		...
		"LOCATION": "redis://%s:%i/%i" % (_CONFIG_.REDIS_HOST, _CONFIG_.REDIS_PORT, _CONFIG_.REDIS_DB_CACHE),
		"OPTIONS": {
...
# A list of anonymous names
ANONYMOUS_PROFILE_IMAGE = "//creditpiggy.cern.ch/static/frontend/img/logo-120.png"
ANONYMOUS_NAMES = [
	"alligator",
	"anteater",
	"armadillo",
